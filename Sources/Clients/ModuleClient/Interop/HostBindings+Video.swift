...
extension HostBindings {
    func video_create_episode_source(
        id_ptr: Int32,
        id_len: Int32,
    ...
    func video_create_episode_server(
        id_ptr: Int32,
        id_len: Int32,
        display_name_ptr: Int32,
        display_name_len: Int32,
    ...
    func video_create_episode_server_response(
        links_ptr: Int32,
        subtitles_ptr: Int32,
    ...
    func video_create_episode_server_link(
        url_ptr: Int32,
        url_len: Int32,
        quality: Int32,
        format: Int32
    ...
    func video_create_episode_server_subtitle(
        url_ptr: Int32,
        url_len: Int32,
        name_ptr: Int32,
        name_len: Int32,
    ...
    func video_create_episode_server_skip_time(
        start_time: Float32,
        end_time: Float32,
        skip_type: Int32
    ) -> Int32 {
