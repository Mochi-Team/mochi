...
//
//                            Group {
//                                Text(group.altTitle ?? "S\(group.id.withoutTrailingZeroes)") +
//                                    Text("\u{2022}") +
...
//
//        @SwiftUI.State
//        var selectedPage: Playlist.Group.Variant.Page?
//
...
//        let page: Playlist.Group.Variant.Page?
