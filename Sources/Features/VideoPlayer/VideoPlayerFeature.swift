...
//            contents: Loadables = .init(),
            ...
            page: Playlist.Group.Variant.ID,
...
//            )
    ...
    public enum Action: FeatureAction {
        public enum ViewAction: SendableAction {
            ...
            case didTapPlayEpisode(Playlist.Group.ID, Playlist.Group.Variant.ID, Playlist.Item.ID)
...
//    var selectedGroup: Loadable<ContentCore.Variants> {
...
//        public var group: Playlist.Group.ID
//        public var page: Playlist.Group.Variant.ID
...
//            case next(Double, Playlist.Group, Playlist.Group.Variant.Page, Playlist.Item.ID)
//
//            var isEnding: Bool {
